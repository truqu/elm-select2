...
Elm.Main.make = function (_elm) {
   ...
   $String = Elm.String.make(_elm);
   var _op = {};
   var filterOptions = F2(function (filter,options) {
      var contains = F2(function (filter,_p0) {
         var _p1 = _p0;
         return A2($String.contains,
         $String.toLower(filter),
         $String.toLower(_p1._1));
      });
      return A2($List.filter,contains(filter),options);
   });
   var getPrevious = F2(function (p,xs) {
      getPrevious: while (true) {
         var _p2 = xs;
         if (_p2.ctor === "[]") {
               return $Maybe.Nothing;
            } else {
               if (_p2._1.ctor === "[]") {
                     ...
                     var _p3 = _p2._1._0;
                     if (p(_p3)) return $Maybe.Just(_p2._0); else {
                           var _v2 = p,_v3 = A2($List._op["::"],_p3,_p2._1._1);
                           p = _v2;
                           xs = _v3;
                           continue getPrevious;
                        }
                  }
            }
      }
   });
   var isHighlighted = F2(function (model,_p4) {
      var _p5 = _p4;
      var _p6 = model.highlight;
      if (_p6.ctor === "Nothing") {
            return false;
         } else {
            return _U.eq(_p5._0,_p6._0);
         }
   });
   var HighlightNext = {ctor: "HighlightNext"};
   var HighlightPrevious = {ctor: "HighlightPrevious"};
   var HighlightTopElement = {ctor: "HighlightTopElement"};
   var ChooseElement = {ctor: "ChooseElement"};
   var onKey = F2(function (address,noop) {
      var message = function (code) {
         var _p7 = code;
         switch (_p7)
         {case 13: return A2($Signal.message,address,ChooseElement);
            case 38: return A2($Signal.message,address,HighlightPrevious);
            case 40: return A2($Signal.message,address,HighlightNext);
            default: return A2($Signal.message,address,noop);}
      };
   ...
   var RemoveHighlight = function (a) {
      return {ctor: "RemoveHighlight",_0: a};
   };
   ...
   var update = F2(function (action,model) {
      update: while (true) {
         ...
         {case "NoOp": return {ctor: "_Tuple2"
                              ,_0: model
                              ,_1: $Effects.none};
            case "ToggleDropdown": var fst = function (_p9) {
                 var _p10 = _p9;
                 return _p10._0;
              };
              var isSelected = function (_p11) {
                 var _p12 = _p11;
                 return _U.eq(_p12._1,model.selection);
              };
              var selectedId = A2($Maybe.map,
              fst,
              $List.head(A2($List.filter,isSelected,model.options)));
              return {ctor: "_Tuple2"
                     ,_0: _U.update(model,
                     {open: $Basics.not(model.open)
                     ,filter: ""
                     ,highlight: selectedId})
                     ,_1: $Effects.none};
            case "Highlight": return {ctor: "_Tuple2"
                                     ,_0: _U.update(model,{highlight: $Maybe.Just(_p8._0)})
                                     ,_1: $Effects.none};
            case "RemoveHighlight": var highlight$ = function () {
                 var _p13 = model.highlight;
                 if (_p13.ctor === "Nothing") {
                       return $Maybe.Nothing;
                    } else {
                       var _p14 = _p13._0;
                       return _U.eq(_p8._0,_p14) ? $Maybe.Nothing : $Maybe.Just(_p14);
                    }
              }();
              return {ctor: "_Tuple2"
                     ,_0: _U.update(model,{highlight: highlight$})
                     ,_1: $Effects.none};
            case "Select": return {ctor: "_Tuple2"
                                  ,_0: _U.update(model,{selection: _p8._0,open: false})
                                  ,_1: $Effects.none};
            case "Filter": var _v11 = HighlightTopElement,
              _v12 = _U.update(model,{filter: _p8._0});
              action = _v11;
              model = _v12;
              continue update;
            case "ChooseElement": var option = A2($List.filter,
              isHighlighted(model),
              model.options);
              var _p15 = option;
              if (_p15.ctor === "::" && _p15._0.ctor === "_Tuple2" && _p15._1.ctor === "[]")
              {
                    var _v14 = Select(_p15._0._1),_v15 = model;
                    action = _v14;
                    model = _v15;
                    continue update;
                 } else {
            ...
            case "HighlightTopElement":
            var option = $List.head(A2(filterOptions,
              model.filter,
              model.options));
              var _p16 = option;
              if (_p16.ctor === "Nothing") {
                    ...
                    var _v17 = Highlight(_p16._0._0),_v18 = model;
                    action = _v17;
                    model = _v18;
                    continue update;
                 }
            case "HighlightPrevious": var previous = A2(getPrevious,
              isHighlighted(model),
              model.options);
              var _p17 = previous;
              if (_p17.ctor === "Just") {
                    return {ctor: "_Tuple2"
                           ,_0: _U.update(model,{highlight: $Maybe.Just(_p17._0._0)})
                           ,_1: $Effects.none};
                 } else {
                    return {ctor: "_Tuple2",_0: model,_1: $Effects.none};
                 }
            default: var next = A2(getPrevious,
              isHighlighted(model),
              $List.reverse(model.options));
              var _p18 = next;
              if (_p18.ctor === "Just") {
                    return {ctor: "_Tuple2"
                           ,_0: _U.update(model,{highlight: $Maybe.Just(_p18._0._0)})
                           ,_1: $Effects.none};
                 } else {
                    return {ctor: "_Tuple2",_0: model,_1: $Effects.none};
                 }}
   ...
   var ToggleDropdown = {ctor: "ToggleDropdown"};
   var NoOp = {ctor: "NoOp"};
   var single = F2(function (address,model) {
      var makeOption = function (_p19) {
         var _p20 = _p19;
         var _p24 = _p20._1;
         var _p23 = _p20._0;
         var chosenClass = _U.eq(model.selection,_p24);
         var ariaSelected = $String.toLower($Basics.toString(chosenClass));
         var activeClass = A2($Maybe.withDefault,
         false,
         A2($Maybe.map,
         function (id$) {
            return _U.eq(id$,_p23);
         },
         model.highlight));
         return A2($Html.li,
         _U.list([$Html$Attributes.classList(_U.list([{ctor: "_Tuple2"
                                                      ,_0: "select2-results__option"
                                                      ,_1: true}
                                                     ,{ctor: "_Tuple2"
                 ...
                 ,A2($Html$Attributes.attribute,"aria-selected",ariaSelected)
                 ,A3($Html$Events.on,
                 "mouseover",
                 $Json$Decode.value,
                 function (_p21) {
                    return A2($Signal.message,address,Highlight(_p23));
                 })
                 ,A3($Html$Events.on,
                 "mouseout",
                 $Json$Decode.value,
                 function (_p22) {
                    return A2($Signal.message,address,RemoveHighlight(_p23));
                 })
                 ,A2($Html$Events.onClick,address,Select(_p24))]),
         _U.list([$Html.text(_p24)]));
      };
      var options = A2(filterOptions,model.filter,model.options);
      var optionsList = A2($List.map,makeOption,options);
      var open = model.open;
      var openClass = open ? " select2-container--open" : "";
      return A2($Html.span,
      ...
      _U.list([A2($Html.span,
              _U.list([$Html$Attributes.$class("selection")]),
              _U.list([A2($Html.span,
              _U.list([$Html$Attributes.$class("select2-selection select2-selection--single")
                      ,A2($Html$Events.onClick,address,ToggleDropdown)]),
              _U.list([A2($Html.span,
                      _U.list([$Html$Attributes.$class("select2-selection__rendered")]),
                      _U.list([$Html.text(model.selection)]))
                      ,A2($Html.span,
                      _U.list([$Html$Attributes.$class("select2-selection__arrow")]),
                      _U.list([A2($Html.b,_U.list([]),_U.list([]))]))]))]))
              ,A2($Html.span,
              _U.list([$Html$Attributes.$class(A2($Basics._op["++"],
                      ...
                      ,$Html$Attributes.style(_U.list([{ctor: "_Tuple2"
                                                       ,_0: "position"
                                                       ,_1: "absolute"}
                                                      ,{ctor: "_Tuple2",_0: "top",_1: "25px"}
                                                      ,{ctor: "_Tuple2",_0: "width",_1: "100%"}]))]),
              _U.list([A2($Html.span,
              _U.list([$Html$Attributes.$class("select2-dropdown select2-dropdown--below")]),
              _U.list([A2($Html.input,
                      _U.list([$Html$Attributes.$class("select2-search__field")
                              ,$Html$Attributes.style(_U.list([{ctor: "_Tuple2"
                                                               ,_0: "margin"
                                                               ,_1: "4px"}
                                                              ,{ctor: "_Tuple2",_0: "width",_1: "calc(100% - 8px)"}
                                                              ,{ctor: "_Tuple2",_0: "box-sizing",_1: "border-box"}]))
                              ,A3($Html$Events.on,
                              "input",
                              $Html$Events.targetValue,
                              function (_p25) {
                                 return A2($Signal.message,address,Filter(_p25));
                              })
                              ,A2(onKey,address,NoOp)
                              ,$Html$Attributes.value(model.filter)]),
                      _U.list([]))
                      ,A2($Html.span,
                      _U.list([$Html$Attributes.$class("select2-results")
                              ,$Html$Attributes.style(_U.list([{ctor: "_Tuple2"
                                                               ,_0: "margin"
                                                               ,_1: "0px"}
                                                              ,{ctor: "_Tuple2",_0: "padding",_1: "0px"}]))]),
                      _U.list([A2($Html.ul,
                      _U.list([$Html$Attributes.$class("select2-results__options")]),
                      optionsList)]))]))]))]));
   });
   var view = F2(function (address,model) {
      return A2($Html.div,
      _U.list([$Html$Attributes.$class("main-content")]),
      _U.list([A2($Html.div,
      _U.list([$Html$Attributes.$class("page-content")
              ,$Html$Attributes.style(_U.list([{ctor: "_Tuple2"
                                               ,_0: "overflow"
                                               ,_1: "visible"}]))]),
      _U.list([A2($Html.div,
      _U.list([$Html$Attributes.$class("col-md-6 portlets")]),
      _U.list([A2($Html.div,
      _U.list([$Html$Attributes.$class("panel")]),
      _U.list([A2($Html.div,
      _U.list([$Html$Attributes.$class("panel-content")]),
      _U.list([A2($Html.div,
      _U.list([$Html$Attributes.$class("form-group")]),
      _U.list([A2(single,address,model)]))]))]))]))]))]));
   });
   var init = {ctor: "_Tuple2"
              ,_0: {open: false
                   ,highlight: $Maybe.Nothing
                   ,selection: "Choose"
                   ,options: _U.list([{ctor: "_Tuple2",_0: 1,_1: "Choose"}
                                     ,{ctor: "_Tuple2",_0: 2,_1: "Me"}
                                     ,{ctor: "_Tuple2",_0: 3,_1: "Pikachu"}])
                   ,filter: ""}
              ,_1: $Effects.none};
   ...
   return _elm.Main.values = {_op: _op
                             ...
                             ,HighlightTopElement: HighlightTopElement
